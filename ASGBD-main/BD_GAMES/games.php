...
<body>
    ...
    <div class="container">
        ...
        <a href="insert_game.php" class="btn btn-add">Agregar Juego</a>
        ...
        <table>
            ...
            <?php while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
                        <a href="update_game.php?id=<?php echo $row['ID_GAME']; ?>" class="btn btn-edit">Modificar</a>
                        <a href="delete_game.php?id=<?php echo $row['ID_GAME']; ?>" class="btn btn-delete">Eliminar</a>
                    </td>
                </tr>
            <?php endwhile; ?>
        </table>
